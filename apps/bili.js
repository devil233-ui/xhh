...
async function handleBilibiliLink(e) {
  ...
  const urlPatterns = [
    ...
    {
      pattern: /https?:\/\/m\.bilibili\.com\/video\/([\w]+)/,
      handler: (bv, e) => bili.video(e, bv, false, true),
    },
    {
      pattern: /https?:\/\/www\.bilibili\.com\/opus\/([\w]+)/,
      handler: (dt_id, e) => bili.dt(dt_id, e),
    },
    {
      pattern: /https?:\/\/m\.bilibili\.com\/opus\/([\w]+)/,
      handler: (dt_id, e) => bili.dt(dt_id, e),
    },
    {
      pattern: /https?:\/\/m\.bilibili\.com\/dynamic\/([\w]+)/,
      handler: (dt_id, e) => bili.dt(dt_id, e),
    },
    {
      pattern: /https?:\/\/t\.bilibili\.com\/([\w]+)/,
      handler: (dt_id, e) => bili.dt(dt_id, e),
    },
    {
      pattern: bvPattern,
