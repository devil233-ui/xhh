...
export class AbyssNow extends plugin {
  constructor(e) {
    super({
      ...
      rule: [
        {
          reg: '^#*(?:xhh|小花火)?(原神|星铁|星穹|崩铁)?(?:([0-9]{1,2}\\.[0-9]{1,2}))?(?:第?([0-9]{2,4})期)?(?:上一期|上期|上一|下一期|下期|下一)?(?:([0-9]{1,2})层)?(深境螺旋|深境|深渊|幻想真境剧诗|幻想剧诗|幻想|真境|剧诗|幽境危战|幽境|危战|混沌回忆|混沌|回忆|虚构叙事|虚构|末日幻影|末日|幻影|异相仲裁|异相|仲裁|王棋)(?:([0-9]{1,2})层)?(?:上一期|上期|上一|下一期|下期|下一)?(速览|一览|详情|情报|阵容)$',
          fnc: 'overview',
        },
      ],
    });
